...
class Sheep(RandomWalker):
    ...
    def step(self):
        ...
        if alive and self.random.random() < self.model.sheep_reproduce:
            # Reproducing:
            baby = Sheep(self.model.next_id(), self.pos, self.model, self.moore, self.energy)
    ...
    def step(self):
        ...
        # Reproducing
            ...
            if self.random.random() < self.model.wolf_reproduce:
                baby = Wolf(self.model.next_id(), self.pos, self.model, self.moore, self.energy)
                self.model.grid.place_agent(baby, baby.pos)
                self.model.schedule.add(self, baby)
